...
<p align="center">
  <img src="assets/servers.png" alt="Выбор сервера" width="800" style="border-radius: 10px; box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
</p>
...
|:-----------------------------------------------------------:|:---------------------------------------------------------:|
| <img src="assets/login.png" alt="Экран входа" width="100%"> | <img src="assets/profile.png" alt="Профиль" width="100%"> |

### Настройки и Персонализация
|                            Глобальные настройки                            |                            Настройки клиента                             |
|:--------------------------------------------------------------------------:|:------------------------------------------------------------------------:|
| <img src="assets/main_settings.png" alt="Настройки лаунчера" width="100%"> | <img src="assets/server_settings.png" alt="Настройки игры" width="100%"> |
...
Вам понадобится **JDK 21** или выше.
