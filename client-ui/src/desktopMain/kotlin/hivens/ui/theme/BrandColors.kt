...
// avatars. All read off the themed [CelestiaColors] tokens, so the source
...
fun CelestiaColors.origin(origin: PackOrigin): Color = when (origin) {
...
fun CelestiaColors.source(source: SmrtSource): Color = when (source) {
...
fun CelestiaColors.originGradient(origin: PackOrigin): Brush {
...
fun CelestiaColors.decorativeColor(name: String): Color =
 ...
 */
fun CelestiaColors.decorativePair(name: String): Pair<Color, Color> {
