...
// Navigation context for the new home surface. Widgets in home.new.main read
// live appState + nav dispatcher. The session lifts from AppState.Authenticated
// where applicable; widgets that need it guard on the cast themselves.
