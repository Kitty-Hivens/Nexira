...
object GermanStrings : AppStrings {
    ...
    override val settingsAutoUpdatePacksDesc    = "Hält installierte Mirror-Packs auf dem neuesten Build. Sichere Updates laufen im Hintergrund; eine Minecraft- oder Loader-Änderung folgt der Regel darunter. Ausschalten, um Packs von Hand zu aktualisieren."
    ...
    override fun packVersionLatestBuilt(version: String, publishedAt: String) = "Neuester Build: $version, veröffentlicht $publishedAt"
    ...
    override val packContentPresenceServer      = "Nur Server"
    override val packContentPresenceBoth        = "Client und Server"
    ...
    override fun notifPackUpdatePending(packName: String, version: String) = "$packName: Build $version verfügbar"
    override fun notifPackUpdated(packName: String, version: String) = "$packName auf $version aktualisiert"
    override fun notifPackUpdateFailed(packName: String) = "$packName: Update fehlgeschlagen"
