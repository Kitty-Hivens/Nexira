...
object RussianStrings : AppStrings {
    ...
    override val settingsAutoUpdatePacksDesc    = "Держать установленные сборки зеркала на последней версии. Безопасные обновления ставятся в фоне; смена версии Minecraft или загрузчика идёт по правилу ниже. Выключи, чтобы обновлять вручную."
    override val settingsAmberPolicy            = "Структурные обновления"
    override val settingsAmberPolicyDesc        = "Что фоновый проход делает со сменой версии Minecraft или загрузчика — она может испортить миры, конфиги и состояние модов. Снимок делается всегда перед применением, а вариант с текущей сборкой ещё и убирает напоминания."
