...
object RussianStrings : AppStrings {
    ...
    override val settingsAdaptiveMemoryDesc     = "Новые сборки сами подбирают размер хипа по реальному потреблению пака, уточняя за несколько сессий. Выбор конкретного значения RAM отключает Авто для этой сборки; выключи, чтобы у всех был фиксированный дефолт."
