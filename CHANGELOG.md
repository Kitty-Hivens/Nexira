...
- The light palette had no direction. Its ladder straddled the page, so a raised plane and a sunken one were the same distance from it and depth said nothing, a requested depth was discarded outright, and the chrome met the page on nothing. Colours taken from the wallpaper relit every plane rather than tinting it, and a light theme came out as two different themes depending on whether a wallpaper was set.
