 ...
 *
 * Duplicated from `:client-core` deliberately: `:widget-model` is a leaf module
 * that shares no lower module with `:client-core`, and a new module for ~20
 * lines is not worth the Gradle edge.
 */
